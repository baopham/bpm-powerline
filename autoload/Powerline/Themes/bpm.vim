let undotree_status_bar = {
    \ 'undotree': Pl#Match#Add('bufname(winbufnr(a:window))', 'undotree'),
    \ 'diffpanel': Pl#Match#Add('bufname(winbufnr(a:window))', 'diffpanel')
\}
call extend(g:Powerline#Matches#matches, undotree_status_bar)

let g:Powerline#Themes#bpm#theme = Pl#Theme#Create(
	\ Pl#Theme#Buffer(''
		\ , 'paste_indicator'
		\ , 'mode_indicator'
		\ , 'fugitive:branch'
	...
	\ Pl#Theme#Buffer('nerdtree'
		\ , ['raw.name', '%{fnamemodify(Powerline#Functions#GetShortPath(4), ":h")}']
		\ , Pl#Segment#Truncate()
		\ , Pl#Segment#Split()
	\ ),
	\
	\ Pl#Theme#Buffer('undotree'
